			...
			<section className="description__content">
				...
				<div className="description__announce">
					<div className="description__text">
						<p>Знаешь ли ты, дорогой друг, настоящего Бога? Или ты живёшь в иллюзии, которую ты сам себе нарисовал — в красивой или, наоборот, ужасной иллюзии?</p>
					</div>
					<div className="description__text">
					...
					<div className="description__text">
						<p>Раскрывать тему и делиться словом будут братья — служители наших церквей, а также гости. Также вас ждут:</p>
						<ul>
